...
import FieldBtns from '../styleComponent/Signup/FieldBtns';
...
export default function SignupFM() {
  ...
  const sendVerificationEmail = () => {
    const actionCodeSettings = {
      url: `http://localhost:3000/2023_MONIVATION/account/create/financial-manager?email=${inputEmail}`,    
  ...
  /* 일반 이메일로 가입했을떄 */ 
    ...
    .then((userCredential) => {
        ...
        console.log(user)
        addDoc(collection(db, "financial_managers"), {
          uid : user.uid,
          name : inputName,
          email : gotEmail,
          photo : "없음",
